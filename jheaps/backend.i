...
enum heap_type_t {
    ...
    HEAP_TYPE_MERGEABLE_ADDRESSABLE_RANKPAIRING,
    HEAP_TYPE_MERGEABLE_ADDRESSABLE_COSTLESSMELD_PAIRING,
...
class HeapType(Enum):
    ...
    HEAP_TYPE_MERGEABLE_ADDRESSABLE_RANKPAIRING = _backend.HEAP_TYPE_MERGEABLE_ADDRESSABLE_RANKPAIRING
    HEAP_TYPE_MERGEABLE_ADDRESSABLE_COSTLESSMELD_PAIRING = _backend.HEAP_TYPE_MERGEABLE_ADDRESSABLE_COSTLESSMELD_PAIRING
